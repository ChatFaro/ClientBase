package cn.clientbase.ui.hud;

import cn.clientbase.module.Category;
import cn.clientbase.module.Module;
import cn.clientbase.util.animation.Easing;
import cn.clientbase.util.animation.EasingAnimation;
import cn.clientbase.util.misc.MouseUtil;
...
public abstract class Drag extends Module {
    ...
    public void updatePos() {
        ...
        this.renderX = (float) this.xAnimation.getValue();
        this.renderY = (float) this.yAnimation.getValue();
    }
